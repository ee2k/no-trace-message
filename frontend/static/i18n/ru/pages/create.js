export default {
  create: {
    subtitle: 'Безопасная и анонимная <a href="{{urls.opensource}}" class="hyperlink" target="_blank">open-source платформа</a>',
    features: {
    ...
    errors: {
      ...
      TOO_MANY_ATTEMPTS: 'Слишком много запросов. Подождите {{minutes}} минут',
