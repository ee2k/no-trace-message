export default {
  create: {
    subtitle: 'Uma plataforma <a href="{{urls.opensource}}" class="hyperlink" target="_blank">open source</a> segura e anônima',
    features: {
    ...
    errors: {
      ...
      TOO_MANY_ATTEMPTS: 'Muitas solicitações. Por favor, aguarde {{minutes}} minutos',
