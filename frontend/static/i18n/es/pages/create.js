export default {
  create: {
    subtitle: 'Una plataforma <a href="{{global.opensource}}" class="hyperlink" target="_blank">de código abierto</a> segura y anónima',
    features: {
    ...
    errors: {
      ...
      TOO_MANY_ATTEMPTS: 'Demasiadas solicitudes. Por favor, espera {{minutes}} minutos',
