export default {
  create: {
    subtitle: 'Eine sichere, anonyme <a href="{{urls.opensource}}" class="hyperlink" target="_blank">Open-Source-Plattform</a>',
    features: {
    ...
    errors: {
      ...
      TOO_MANY_ATTEMPTS: 'Zu viele Anfragen. Bitte warten Sie {{minutes}} Minuten',
